...
#0 выход
#TODO pep 8; pep 257; расширить загрузку файла, чтоб можно было подавать списки и через пробел;добавить функцию сохранения вывода; оформить загрузку и выгрузку в поле в меню;подготовить презентацию
####################################
from tkinter import *
